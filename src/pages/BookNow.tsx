      ...
      <div className="lg:col-span-1">
          ...
          <div
            ...
            className={`flex items-center gap-2 px-4 py-3 rounded-lg border-2 cursor-pointer transition-all ${
              selectedPriceType === 'day'
                ? 'border-transparent bg-gradient-to-r from-[#0B0E92] to-[#69A6F0] text-white'
        ...
        {!showContactButtons ? (
          <button
            onClick={() => setIsDateTimeModalOpen(true)}
            disabled={isSubmittingBooking || currentBookingStatus === 'rejected'}
            className={`w-full bg-gradient-to-r from-[#0B0E92] to-[#69A6F0] text-white py-3 px-6 rounded-lg
