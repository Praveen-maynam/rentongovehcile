...
//         // Check if this is a real MongoDB ID or demo ID
//         const isRealId = isValidObjectId(id);
        
//         if (!isRealId) {
//           console.log("🎭 Demo vehicle detected:", id);
//           console.log("✅ Using local demo data from vehicles array");
          
//           // For demo vehicles, just use the local data
//           const demoVehicle = vehicles.find(v => v.id === id);
          
//           if (demoVehicle) {
//             console.log("✅ Demo vehicle found:", demoVehicle);
//             // Transform demo vehicle to match API data structure
//             const transformedData = {
//               _id: demoVehicle.id,
//               CarName: demoVehicle.name,
//               bikeName: demoVehicle.type === 'Bike' ? demoVehicle.name : undefined,
//               carImages: [demoVehicle.image],
//               bikeImages: demoVehicle.type === 'Bike' ? [demoVehicle.image] : [],
//               RentPerDay: demoVehicle.price,
//               TransmissionType: demoVehicle.transmission,
//               FuelType: demoVehicle.fuel,
//               SeatingCapacity: demoVehicle.seats,
//               Carseater: demoVehicle.seats,
//               pickupArea: demoVehicle.location,
//               pickupCity: demoVehicle.location,
//             };
//             setApiCarData(transformedData);
//             setLoadingCarData(false);
//             return;
//           } else {
//             throw new Error(`Demo vehicle with ID "${id}" not found in local data`);
//           }
//         }
        
//         // For real MongoDB IDs, fetch from API
//         console.log("🌐 Real vehicle ID detected, fetching from API:", id);
...
//     console.log("🎭 Demo mode: Skipping average rating API call");
//     if (!silent) setLoadingAverageRating(false);
//     return;
//   }
...
//   // Skip API call for demo vehicles
//   if (!isValidObjectId(vehicleId)) {
//     console.log("🎭 Demo mode: Skipping reviews API call");
//     if (!silent) {
...
const BookNow: React.FC = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
      {/* LEFT COLUMN: Vehicle Image */}
      <div className="lg:col-span-1">
        <div className="w-[409px] h-[409px] overflow-hidden rounded-xl mb-4 relative">
          <img
            src={currentVehicle.image}
            alt={currentVehicle.name}
          ...
          <div className="absolute bottom-4 left-0 right-0 flex justify-center space-x-2">
            ...
            <span className="w-3 h-3 rounded-full bg-gray-400 shadow-md"></span>
            <span className="w-3 h-3 rounded-full bg-gray-400 shadow-md"></span>
          </div>
        </div>
      </div>
...
/>
          ...
          // <CustomerBookingCalendar
          //   isOpen={isDateTimeModalOpen}
          //   vehicleId={currentVehicle?.id || id || ''}
          //   vehicleType={mapVehicleTypeForAPI(currentVehicle?.type)}
          //   vehicleName={currentVehicle.name}
          //   pricePerDay={parseInt(currentVehicle.price)}
          //   userId={currentUserId}
          //   onClose={() => {
          //     setIsDateTimeModalOpen(false);
          //     setApiError("");
          ...
          //   onConfirm={async (data) => {
          //     console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
          //     console.log("✅ Customer confirmed booking from calendar");
          //     console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
          ...
          //     // Block dates immediately using createNotAvailability API
          //     console.log("🔒 Blocking dates for all users (Owner + Customers)...");
          ...
          //     console.log("  - From:", formattedFromDate, "at", formattedFromTime);
          //     console.log("  - To:", formattedToDate, "at", formattedToTime);
          ...
          //       urlencoded.append("VechileId", currentVehicle?.id || id || '');
          //       urlencoded.append("pricePerDay", String(currentVehicle?.price || '0'));
          //       urlencoded.append("pricePerHour", String(currentVehicle?.price || '0'));
          //       urlencoded.append("pricePerKm", String(currentVehicle?.price || '0'));
          //       urlencoded.append("contactNumber", contactNumber || '799');
          //       urlencoded.append("contactName", userData?.name || '');
          //       urlencoded.append("latitude", userData?.latitude || "17.438095");
          //       urlencoded.append("longitude", userData?.longitude || "78.4485");
          //       urlencoded.append("fromDate", formattedFromDate);
          //       urlencoded.append("toDate", formattedToDate);
          //       urlencoded.append("fromTime", formattedFromTime);
          //       urlencoded.append("toTime", formattedToTime);
          //       urlencoded.append("isNotAvailable", "true");
          //       urlencoded.append("bikeImages", "");
          //       urlencoded.append("isCustomerBooking", "true");
 
          //       console.log("📤 Sending to createNotAvailability API...");
          //       console.log("API Body:", Object.fromEntries(urlencoded));
          ...
          //       if (response.ok) {
          //         console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
          //         console.log("🎉 SUCCESS! Dates blocked for everyone!");
          //         console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
          //         console.log("🔴 These dates now show as BLOCKED:");
          //         console.log("   ✅ Owner Calendar: ORANGE (customer booked)");
          //         console.log("   ✅ All Customer Calendars: RED STRIKE");
          //         console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                 
          //         toast.success("🎉 Booking confirmed! Dates blocked for everyone.", {
          //           duration: 5000,
          //           position: 'top-center',
          //         });
