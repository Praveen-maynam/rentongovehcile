...
//           />
//           {/* Image Navigation Dots - Inside Image at Bottom */}
...
//       {/* Price Boxes - Day and Hour (Side by Side with Icons) */}
...
//         {/* Icons Row - 4 Icons with Labels and Dividers */}
...
//           <div className="flex flex-col items-center gap-2 flex-1">
//             <div className="w-[50px] h-[50px] flex items-center justify-center">
//               <img src={LocationIcon} alt="AC" className="w-full h-full object-contain" />
//             </div>
...
//           {displayRatingDistribution.map((r) => (
//             <div key={r.stars} className="flex items-center text-sm">
//               <span className="w-8 text-gray-700 font-medium">{r.stars}<span className="text-yellow-400 text-xl">★</span>
// </span>
//               <div className="flex-1 bg-gray-200 h-3 rounded-full mx-3 overflow-hidden">
//                 <div
//                   className="bg-gradient-to-r from-yellow-400 to-orange-400 h-3 rounded-full transition-all duration-500"
