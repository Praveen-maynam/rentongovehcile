...
// // ✅ FIX 1: Get current user ID (the person using the app)
//   const currentUserId = localStorage.getItem('userId') || 'user-' + Date.now();

//   // ✅ FIX 2: Get the vehicle owner ID (the person who owns the vehicle)
//   const vehicleOwnerId = vehicleData?.userId || vehicleData?.ownerId || passedBooking?.ownerId || 'temp-owner-' + Date.now();

//   // ✅ FIX 3: Get the booking ID
//   const bookingId = passedBooking?._id || passedBooking?.bookingId || vehicleId || 'temp-booking-' + Date.now();

//   // ✅ FIX 4: Determine sender/receiver types
//   const senderType = "user";
//   const receiverType = "owner";

//   console.log("📋 ========= CHAT IDS DEBUG =========");
//   console.log("👤 Current User ID (senderId):", currentUserId);
//   console.log("👥 Vehicle Owner ID (receiverId):", vehicleOwnerId);
...
//   ownerAvatar={`https://api.dicebear.com/7.x/avataaars/svg?seed=${vehicleData.contactName}`}
//   senderId={currentUserId}              // ✅ Changed from userId
//   receiverId={vehicleOwnerId}           // ✅ Changed from chatBookingId
//   bookingId={bookingId}                 // ✅ Real booking ID
