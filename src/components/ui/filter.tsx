...
// //   - Single-file filter drawer component for Cars/Bikes (GET /getNearbyCars, /getNearbyBikes)
// //   - Uses the uploaded image as the drawer header icon. (Local file path used below.)

// //   Requirements:
// //   - Tailwind CSS configured in your app
// //   - axios installed: npm i axios

// //   How to use:
// //   <FilterDrawer
// //     latitude={17.4417}
// //     longitude={78.4416}
// //     onApply={(vehicles) => { /* handle results */ }}
// //     type={"car"} // or "bike"
// //   />
...
// //   defaultRangeKm?: number; // default slider distance
// // };

// // const UPLOADED_IMAGE = "/mnt/data/60aed9dd-c0ba-4706-b7f5-ffccf817f813.png"; // developer-provided local path
...
// //     if (priceMax < priceMin) setPriceMax(priceMin + 1);
...
// //     return `${
// //       vehicleType === "bike" ? "/getNearbyBikes" : "/getNearbyCars"
// //     }?${params.toString()}`;
// //   };
...
// //       // In production set the base URL in axios config or use a full URL
// //       const res = await axios.get(url);

// //       if (res.data && res.data.vehicles) {
// //         setResults(res.data.vehicles);
// //         onApply && onApply(res.data.vehicles);
// //       } else if (res.data && res.data.success && res.data.vehicles) {
// //         setResults(res.data.vehicles);
// //         onApply && onApply(res.data.vehicles);
// //       } else if (res.data && res.data.success && res.data.booking) {
// //         // defensive: for different backend shapes
// //         setResults([res.data.booking]);
// //         onApply && onApply([res.data.booking]);
// //       } else {
// //         setResults([]);
// //         onApply && onApply([]);
// //       }
...
// //         <aside className="relative z-50 w-full sm:max-w-sm bg-white rounded-2xl shadow-2xl m-4 p-6">
// //           {/* Header */}
...
// //               {results.length === 0 && <div className="text-sm text-gray-500">No vehicles found</div>}

// //               {results.map((v) => (
// //                 <div key={v._id} className="flex items-center gap-3 p-3 border rounded-lg">
// //                   <img src={UPLOADED_IMAGE} alt="vehicle" className="w-12 h-12 object-cover rounded-md" />
// //                   <div>
// //                     <div className="font-semibold">{v.name}</div>
// //                     <div className="text-sm text-gray-500">{v.fuelType} • {v.transmissionType}</div>
// //                   </div>
