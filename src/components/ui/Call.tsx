...
// // // ----------- Socket & API setup -----------
// // const SOCKET_SERVER_URL = "http://3.110.122.127:3000";
...
//   // ----------- Initialize Socket -----------
//   useEffect(() => {
//     const wsUrl = socketServerUrl.replace('http://', 'ws://').replace('https://', 'wss://');
...
//       // Register user with MongoDB ObjectId
//       emitSocket("register-user", { userId });
//     };
...
//   const handleReceiveIce = async (data: IceCandidateData) => {
//     if (!peerConnection.current) {
...
//         // Update call status in backend when connected
...
//           const target = role === "caller" ? receiverId : incomingCall?.call.callerId;
...
//         // Save offer to database with receiverSocketId
//         await apiCall("/save-offer", { 
//           callId, 
//           offer,
//           receiverSocketId: socketRef.current?.url || "" // Save receiver socket ID
//         });
        
//         // Send offer via socket
//         emitSocket("send-offer", { 
//           to: receiverId, 
//           offer,
//           from: userId,
//           callId
...
//     try {
//       // Create call entry using your backend API
//       const result = await apiCall("/start", {
//         callerId: userId,
//         receiverId,
//         callType: "video",
//         callerSocketId: socketRef.current?.url || ""
//       });
...
//     console.log("✅ Accepting call from:", incoming.call.callerId);
//     setIncomingCall(null);
//     setCallId(incoming.call._id);
//     setIsCalling(true);
//     setCallStatus("accepted");

//     try {
//       // Initialize WebRTC
//       await initWebRTC(incoming.call._id, "receiver");
...
//         await peerConnection.current.setRemoteDescription(
//           new RTCSessionDescription(incoming.call.offer)
//         );
...
//       emitSocket("send-answer", { 
//         to: incoming.call.callerId, 
//         answer,
//         from: userId
//       });
...
//     if (incomingCall && incomingCall.call._id) {
//       try {
...
//         // Notify caller
//         emitSocket("call-ended", {
//           to: incomingCall.call.callerId,
//           from: userId,
//           callId: incomingCall.call._id,
//           reason: "rejected"
//         });
...
//         // Notify other user
//         const otherUser = incomingCall?.call.callerId || receiverId;
//         emitSocket("end-call", {
//           to: otherUser,
//           from: userId,
//           callId
...
//                 From: {incomingCall.call.callerId.substring(0, 8)}...
//               </p>
...
//                     {(receiverId || incomingCall?.call.callerId || 'Remote').substring(0, 8)}...
//                   </span>
//                 </div>
//                 <video 
//                   ref={remoteVideoRef} 
